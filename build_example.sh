...
#build and export
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "TwoWayStreaming" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/TwoWayStreaming -archivePath out-build/TwoWayStreaming
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "MediaDevices" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/MediaDevices -archivePath out-build/MediaDevices
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "Player" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/Player -archivePath out-build/Player
xcodebuild -exportArchive -exportOptionsPlist Info_ipa.plist -archivePath out-build/Player.xcarchive -exportPath out-build

xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "TwoPlayers" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/TwoPlayers -archivePath out-build/TwoPlayers
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "Streamer" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/Streamer -archivePath out-build/Streamer
xcodebuild -exportArchive -exportOptionsPlist Info_ipa.plist -archivePath out-build/Streamer.xcarchive -exportPath out-build

xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "StreamRecording" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/StreamRecording -archivePath out-build/StreamRecording
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "Conference" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/Conference -archivePath out-build/Conference
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "VideoChat" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/VideoChat -archivePath out-build/VideoChat
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "PhoneMinVideo" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/PhoneMinVideo -archivePath out-build/PhoneMinVideo
...
xcodebuild CODE_SIGN_STYLE=Automatic -UseModernBuildSystem=NO -workspace 'WCSExample.xcworkspace' -scheme "PhoneMin" -configuration="Release" clean archive OBJROOT=$(PWD)/out-build/PhoneMin -archivePath out-build/PhoneMin
